...
try:
    from app.api.nominated_post_routes import router as nominated_post_router
except Exception as e:
    nominated_post_router = None
    logging.exception("Failed to import nominated_post_routes")

try:
    from app.api.nominated_proposal_routes import router as nominated_proposal_router
except Exception as e:
...
try:
    from app.api.cases_dashboard_routes import router as cases_dashboard_router
except Exception as e:
    cases_dashboard_router = None
    logging.exception("Failed to import cases_dashboard_routes")

try:
    from app.api.pulse_routes import router as pulse_router
except Exception as e:
    pulse_router = None
    logging.exception("Failed to import pulse_routes")

try:
    from app.api.meetings_routes import router as meetings_router
except Exception as e:
    meetings_router = None
    logging.exception("Failed to import meetings_routes")

try:
    from app.api.sir_dashboard_routes import router as sir_dashboard_router
except Exception as e:
...
def _warm_pulse_constituencies():
    ...
    def _warm_db():
        try:
            from app.database.db import dakavara_engine, pa_track_engine
    ...
    def _run():
        try:
            from app.services.pulse_service import preload_constituency_views
    ...
    def _run_panel():
        try:
            from app.services import pulse_panel
            pulse_panel.load()
    ...
    def _run_survey():
        try:
            from app.api.pulse_routes import _survey_snapshot
            from app.services import pulse_survey
    ...
    def _run_candidate_pool():
        try:
            ...
            if not CadrePerformanceService.is_configured():
                return
            from app.database.db import dakavara_session, update_session, report_ratings_session
